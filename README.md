...
# 最新版本 2.2.2.1 —— 更新时间：2025年10月29日14点53分
...
#### [DT_20251029_2.2.2.1.apk，适合Android 8+系统](apk/daily/release/DT_20251029_2.2.2.1.apk)

1. 删除悬浮窗开关，改为强制开启（不开启会导致无法进行循环任务）
2. 重构邮箱配置和认证逻辑，添加更详细的错误信息
3. 优化应用内部组件间通信逻辑，降低代码耦合度
4. 优化邮箱配置判断逻辑，改为不设置邮箱也能正常执行任务
5. 优化每日任务重置功能，改为监听系统时间变化
6. **简化邮箱配置，去掉其他邮箱支持，发件箱只支持QQ邮箱**
